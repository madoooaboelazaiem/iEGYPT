<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="original_content.aspx.cs" Inherits="Company.original_content" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="wrap">
   <div class="search">
      <input  id="Text0" type="text" class="searchTerm" placeholder="Typename .."  runat="server" >
       <input  id="Text1" type="text" class="searchTerm" placeholder="Categoryname.."  runat="server" >
            
   </div>
</div> <br />
        <br />
        <br />
        	       <asp:Button id="button1" runat="server" Text="Search" OnClick="button2Clicked" CssClass="searchButton" />
