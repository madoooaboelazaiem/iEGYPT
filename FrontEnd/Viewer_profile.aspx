<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Viewer_profile.aspx.cs" Inherits="Company.Viewer_profile" %>
...
<div class="sidenav">
    <asp:HyperLink ID="HyperLink1" CssClass="linka" runat="server">HyperLink</asp:HyperLink>
    <asp:HyperLink ID="HyperLink2"  CssClass="linka" runat="server">HyperLink</asp:HyperLink>
    <asp:HyperLink ID="HyperLink3" CssClass="linka" runat="server">HyperLink</asp:HyperLink>
    <asp:HyperLink ID="HyperLink4" CssClass="linka" runat="server">HyperLink</asp:HyperLink>
...
<asp:HyperLink ID="HyperLink9" 
          navigateurl="editviewer.aspx"  CssClass="linka" runat="server">Edit</asp:HyperLink>
