<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contributor_profile.aspx.cs" Inherits="Company.Contributor_profile" %>
...
<div class="sidenav">
        <asp:HyperLink ID="HyperLink1" 
          navigateurl="UploadOriginal.aspx" CssClass="linka" runat="server">Upload Original</asp:HyperLink>
          <asp:HyperLink ID="HyperLink2" 
          navigateurl="ReceiveRequests.aspx" CssClass="linka" runat="server">Receive Requests</asp:HyperLink>

          <asp:HyperLink ID="HyperLink3" 
          navigateurl="AcceptRejectRequest.aspx"  CssClass="linka" runat="server">Accept Reject Request</asp:HyperLink>
          <asp:HyperLink ID="HyperLink4" 
          navigateurl="SendMSG.aspx"  CssClass="linka" runat="server">SendMSG</asp:HyperLink>
<asp:HyperLink ID="HyperLink11" 
          navigateurl="UploadNew.aspx"  CssClass="linka" runat="server">Upload New</asp:HyperLink>
          <asp:HyperLink ID="HyperLink12" 
          navigateurl="DeleteContent.aspx"  CssClass="linka" runat="server">Delete Content</asp:HyperLink>
...
<asp:HyperLink ID="HyperLink14" 
          navigateurl="ShowEvent.aspx"  CssClass="linka" runat="server">Show Event</asp:HyperLink>
...
<asp:HyperLink ID="HyperLink9" 
          navigateurl="editcontributer.aspx"  CssClass="linka" runat="server">Edit</asp:HyperLink>
    ...
    <asp:Label id="L2"   runat="server"></asp:Label>
     <br>   
        <asp:Label id="L3" CssClass="" runat="server"></asp:Label>
       <br> 
        <asp:Label id="L4" CssClass="" runat="server"></asp:Label>
