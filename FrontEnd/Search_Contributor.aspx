<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search_Contributor.aspx.cs" Inherits="Company.Search_Contributor" %>
   ...
   <div class="search">
      <input  id="tfullname1" type="text" class="searchTerm" placeholder="Full Name.."  runat="server" >
       <asp:Button id="button2" runat="server" Text="Search" OnClick="button2Clicked" CssClass="searchButton" />
        ...
        <br />
        <asp:Label ID="Label1" runat="server" CssClass="lb"></asp:Label>
