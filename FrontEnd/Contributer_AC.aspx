<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contributer_AC.aspx.cs" Inherits="Company.Contributer_AC" %>
...
<body>
  ...
  <div class="form">
      ...
      <input id="lnmaet" type="text" placeholder="Last Name" required="required" runat="server"/>
             <input id="dobt" type="text" name="input" placeholder="YYYY-MM-DD" required-pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"  runat="server"/>
