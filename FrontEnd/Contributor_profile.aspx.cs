...
namespace Company
{
    public partial class Contributor_profile : System.Web.UI.Page
    {
        ...
        private void GetData()
        {
            ...
            if (Session["ID"] != null)
            {
                ...
                using (SqlDataReader rdr = cmd.ExecuteReader())
                {
                    ...
                    if (Convert.ToString(cmd.Parameters["@specilization"].Value).Length != 0)
                        L3.Text = "<p " + "class" + "=info" + ">" + "<b>specilization</b>" + " <br> " + Convert.ToString(cmd.Parameters["@specilization"].Value) + "</p>";
                    if (Convert.ToString(cmd.Parameters["@years_experience"].Value).Length != 0)
                        L4.Text = "<p " + "class" + "=info" + ">" + "<b>Years Experience</b>" + " <br> " + Convert.ToString(cmd.Parameters["@years_experience"].Value) + "</p>";
                    if (Convert.ToString(cmd.Parameters["@portofolio_link"].Value).Length != 0)
                        L5.Text = "<p " + "class" + "=info" + ">" + "<b>portofolio Link/b>" + "<br>" + Convert.ToString(cmd.Parameters["@portofolio_link"].Value) + "</p>";
                }
