...
namespace Company
{
    public partial class editcontributer : System.Web.UI.Page
    {
        string oldpassword;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add(new SqlParameter("@user_id", Convert.ToInt32(Session["ID"])));
            ...
            else
            {
                ...
                {
                    DateTime Test;
                    if ((birthdate.Length == 0 | DateTime.TryParseExact(birthdate, "yyyy-mm-dd", null, DateTimeStyles.None, out Test) == true) & y)
                    {
                        cmd.ExecuteReader();
